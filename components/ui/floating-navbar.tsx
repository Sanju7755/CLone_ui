            ...
            >
                {navItems.map((navItem: any, idx: number) => (
                    <Link
                        ...
                        href={navItem.link}
                        className={cn(
                            "relative dark:text-neutral-100 items-center flex space-x-1 text-neutral-100 dark:hover:text-neutral-100 hover:text-neutral-500"
                        )}
                    >
                ...
                <button
                    className="border border-neutral-200 dark:border-white/[0.2] bg-white dark:bg-gray-800 text-sm font-medium text-neutral-900 dark:text-white px-4 py-2 rounded-full relative">
